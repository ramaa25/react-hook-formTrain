        ...
        >
          ...
          <span
            className={`text-xl md:absolute md:-translate-x-full ${
              (currentFilter === "checked" && "static translate-x-0") ||
              (currentFilter !== "checked" && "absolute translate-x-full")
        ...
        >
          <AiOutlineClockCircle
            className={`flex-shrink-0 ${
              currentFilter === "uncheck" ? "" : "ml-7"
            }`}
          />
          <span
            className={`md:absolute md:opacity-0 w-full ${
              (currentFilter === "uncheck" && "translate-x-0") ||
              (currentFilter !== "uncheck" && "translate-x-full")
            } duration-300`}
            ref={chek}
