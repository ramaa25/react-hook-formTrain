...
export default function Sidebar({ setFilter, data }: { setFilter: any; data: { value: string; done: boolean }[] }) {
  ...
  return (
    <div className="md:w-20 w-full bg-[#60c0bf] rounded-2xl border-2 border-black overflow-hidden font-semibold px-3 duration-300 transition-all flex bottom-0 left-0 md:static md:block p-3 md:py-0 fixed" ref={side}>
      ...
      <div className="flex md:flex-col gap-3 justify-between w-full items-center ">
        <button className="bg-[#7fbc95] w-12 p-3.5 text-xl rounded-xl border border-black flex gap-2 items-center transition-all duration-300 relative overflow-hidden" ref={allBtn} onClick={() => setFilter(null)}>
          <AiOutlineFileDone />
          <span className="text-xl absolute -translate-x-full w-full flex justify-center items-center opacity-0 duration-300" ref={all} title="All Todo">
            All
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-xl absolute -translate-x-full w-full flex justify-center items-center opacity-0 duration-300" ref={check} title="Checked Todo">
            Checked
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="absolute opacity-0 duration-300" ref={chek} title="Unchecked Todo">
            Uncheked
          </span>
        </button>
      </div>
